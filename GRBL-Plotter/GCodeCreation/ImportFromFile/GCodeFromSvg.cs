    ...
    public static partial class GCodeFromSvg
    {
        ...
        public static bool ConvertFromText(string svgText, bool GetMetaData, bool replaceUnitByPixel)
        {
            ...
            catch (Exception e)
            {
                ...
                System.Windows.Forms.MessageBox.Show("Error '" + e.ToString() + "' in XML string ");
                return false;
            }
        }
        ...
        public static bool ConvertFromFile(string filePath, bool GetMetaData, BackgroundWorker worker, DoWorkEventArgs e)
        {
            ...
            { System.Windows.Forms.MessageBox.Show("Empty file name"); return false; }
            else if (filePath.Substring(0, 4) == "http")
            {
                ...
                using (var wc = new System.Net.WebClient())
                {
                    ...
                    catch { System.Windows.Forms.MessageBox.Show("Could not load content from " + filePath); }
                }
                ...
                else
                {
                    ...
                    System.Windows.Forms.MessageBox.Show("This is probably not a SVG document.\r\nFirst line: " + content.Substring(0, len));
                }
            }
            else
            {
                if (File.Exists(filePath))
                {
                    ...
                    catch (Exception err)
                    {
                        ...
                        System.Windows.Forms.MessageBox.Show("Error '" + err.ToString() + "' in XML file " + filePath + "\r\n\r\nTry to save file with other encoding e.g. UTF-8");
                    }
                }
                else { System.Windows.Forms.MessageBox.Show("File does not exist: " + filePath); return false; }
            }
            return false;
        }
